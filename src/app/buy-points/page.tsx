      ...
      <main className="flex-1 py-8 px-4">
        <div className="max-w-3xl mx-auto animate-fade-in">
          <div className="text-center mb-10">
            <h1 className="text-2xl font-serif font-bold text-brown-600">購買點數</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-xl mx-auto">
            {POINTS_PLANS.map((plan) => (
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-white text-xs font-medium px-4 py-1 rounded-full">
                    最受歡迎
                  </div>
                )}

                <div className="text-4xl mb-3">🪙</div>
                <h2 className="font-serif text-xl font-bold text-brown-600 mb-1">
                  {plan.name}
                </h2>
                <div className="text-3xl font-bold text-brown-600 mb-2">
                  HK${plan.priceHKD}
                </div>
                <div className="text-brown-400 text-sm mb-1">
                  {plan.points} 點數
                </div>
                <div className="text-brown-300 text-xs mb-1">
                  （可生成 {plan.points / POINTS_PER_CARD} 張賀咭）
                </div>
                <div className="text-brown-300 text-xs mb-6">
                ...
                <button
                  ...
                  className={`w-full !py-3.5 rounded-xl font-medium text-base transition-all ${
                    plan.popular
                      ...
                      : 'bg-white text-brown-600 border-2 border-brown-200 hover:border-amber-400 hover:text-amber-400'
          ...
          <div className="mt-12 card p-8">
            <h3 className="font-serif font-semibold text-brown-600 mb-4 text-center">常見問題</h3>
            <div className="space-y-4 max-w-lg mx-auto">
              {[
                ...
                <div key={faq.q} className="text-sm">
                  <p className="font-medium text-brown-600 mb-1">{faq.q}</p>
                  <p className="text-brown-400">{faq.a}</p>
                </div>
              ))}
            </div>
          </div>

          <div className="mt-6 text-center text-xs text-brown-300 space-y-1">
