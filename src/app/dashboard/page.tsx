      ...
      <main className="flex-1 py-8 px-4">
        <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-ink-gray mt-1">準備好製作一張獨一無二的賀咭了嗎？</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-brown-600 to-brown-700 rounded-xl p-6 text-white mb-8 shadow-elevated">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-electric-300/80 text-sm">剩餘點數</p>
                <p className="text-4xl font-bold mt-1">
                  {points !== null ? points : '—'}
                </p>
                <p className="text-electric-300/60 text-xs mt-1">
              ...
              <div className="text-right space-y-2">
                <Link
                  href="/create"
                  className="inline-block bg-electric-500 text-white px-5 py-2.5 rounded-lg font-medium text-sm hover:bg-electric-400/100 transition-colors shadow-lg"
                >
                  ✨ 製作賀咭
                </Link>
                <br />
                <Link
                  href="/buy-points"
                  className="inline-block text-electric-300/70 text-xs hover:text-amber-200 transition-colors"
                >
                  購買點數 →
                </Link>
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            {[
              ...
              >
                ...
                <div className="text-sm font-medium text-ink-white">{item.label}</div>
              </Link>
            ))}
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-serif font-semibold text-ink-white">最近製作</h2>
              <Link href="/history" className="text-sm text-electric-300 hover:text-electric-200 font-medium">
                查看全部 →
              </Link>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {recentCards.map((card) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-ink-gray truncate">
                      {card.festival}
                    </div>
