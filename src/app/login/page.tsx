          ...
          <div className="card-elevated animate-fade-in">
            ...
            <div className="space-y-2.5">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-white/[0.10] bg-white/[0.04] hover:bg-white/[0.08] text-sm font-medium text-ink-white transition-all"
              >
